        ...
        <div v-for="(file, index) in uploadedFiles" :key="index" class="file-item">
          ...
          <div v-if="isImageFile(file.name)" class="relative">
            <img 
              :src="file.preview" 
              alt="preview" 
              class="w-15 h-15 object-cover rounded-lg border border-gray-200" 
            />
            <button 
          ...
          <!-- 非图片文件显示卡片 -->
          <div v-else class="flex items-center gap-2 px-3 py-3 bg-gray-50 rounded-lg border border-gray-200 min-w-0">
            <!-- 文件图标 -->
