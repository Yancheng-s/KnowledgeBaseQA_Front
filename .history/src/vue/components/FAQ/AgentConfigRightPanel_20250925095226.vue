    ...
    <div v-if="selectedFile" class="file-info-container mb-2">
      <div class="flex items-center justify-between p-2 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div class="flex items-center gap-2">
          <i 
            class="fas fa-file-word text-blue-600" 
            v-if="selectedFile.type.includes('word') || selectedFile.name.endsWith('.docx')"
          ></i>
          <i 
            class="fas fa-file-pdf text-red-600" 
            v-else-if="selectedFile.type.includes('pdf') || selectedFile.name.endsWith('.pdf')"
          ></i>
          <i 
            class="fas fa-file-excel text-green-600" 
            v-else-if="selectedFile.type.includes('excel') || selectedFile.name.endsWith('.xlsx')"
          ></i>
          <i 
