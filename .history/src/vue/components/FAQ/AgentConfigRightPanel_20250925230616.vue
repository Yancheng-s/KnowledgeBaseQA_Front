      ...
      <div class="bg-white rounded-lg border border-gray-200 p-4">
        <div class="relative">
          <textarea
            ...
            class="w-full bg-transparent border-none outline-none text-gray-700 text-sm resize-none min-h-[80px]"
          ...
          <!-- 底部操作栏 -->
          <div class="flex items-center justify-between mt-30 pt-3 border-t border-gray-100">
            <!-- 左侧按钮 -->
...
.input-container {
  position: relative;
  margin: 0 20px 40px 20px; /* 增加下边距从20px到40px */
  flex-shrink: 0;
}
